...
# Drosophila data
drosophila_data_path = joinpath(dirname(pathof(MultilocusIsland)), 
    "..", "mapdata/drosophila-rr-RRCv2.3/Comeron_tables/")
...
# Human data
human_data_path = joinpath(dirname(pathof(MultilocusIsland)), 
    "..", "mapdata/human-smoothed_map_b37_4/smoothed_map_b37_4/")
...
human2_data_path = joinpath(dirname(pathof(MultilocusIsland)), 
    "..", "mapdata/humanmap-matise/table1.csv")
